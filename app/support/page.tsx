...
import { appPageShellClass, appPageContainerClass } from "@/lib/layout-foundation";

export const metadata: Metadata = {
  title: "Freelance Invoicing Support & GST FAQs | Lance",
  description: "Get answers to frequently asked questions about GST compliance, international invoicing, and using the Lance smart invoice engine.",
};
      ...
      <div className={cn(appPageContainerClass, "pt-24 pb-12 text-center")}>
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Everything you need to know about professional billing, GST compliance, and mastering the Lance workflow.
          </p>
        </div>
      </div>

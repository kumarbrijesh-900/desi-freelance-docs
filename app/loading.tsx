      ...
      <div className="flex-grow p-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex justify-between items-end mb-12">
          <div className="space-y-4">
            ...
            <div className="h-4 w-48 bg-zinc-50 rounded animate-pulse" />
          </div>
          <div className="h-12 w-32 rounded-lg bg-zinc-100 animate-pulse" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="p-6 border border-[color:var(--border-subtle)] bg-white rounded-xl space-y-4">
              <div className="h-4 w-1/2 bg-zinc-50 rounded animate-pulse" />
              <div className="h-8 w-full bg-zinc-100 rounded animate-pulse" />
              <div className="pt-4 flex justify-between">
                <div className="h-4 w-24 bg-zinc-50 rounded animate-pulse" />
                <div className="h-4 w-16 bg-zinc-50 rounded animate-pulse" />
              </div>
            </div>
          ))}
        </div>

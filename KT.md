...
> **Last Updated:** 2026-04-23 (Session: Phases 1–9d complete — auth-gated saving, branded watermark, expanded template access)
> **Branch:** `main`
...
- **Auth-Gated Preview:** Gated "Save Draft", "Share", "Print", and "PDF Export" buttons in the Preview screen to require login.

...
const BRIEFS: Record<string, string> = {
  ...
  D2: "Raise an invoice from Ruhnika Creative Studio (Bhubaneswar, Odisha, GSTIN 21AAPFR2345K1Z5) to Kaveri Tech Labs, Bengaluru, Karnataka. One line item: complete UX audit and redesign of their onboarding flow — ₹2,40,000, SAC 998314. Invoice date 5 July 2026, due 20 July 2026, net 15 days. Payment by bank transfer: HDFC Bank, account 50200045671234, IFSC HDFC0001234.",

...
export const appSectionShellClass =
  "rounded-[var(--app-radius-shell)] border border-[color:var(--color-ink)] bg-[color:var(--color-paper)] shadow-[var(--app-elevation-soft)]";

export const appSectionHeaderClass =
  "flex flex-wrap items-start justify-between gap-4 border-b border-[color:var(--color-ink)] px-5 py-4";
...
export const appStickyRailClass =
  "rounded-[var(--app-radius-card)] border border-[color:var(--color-ink)] bg-[color:var(--color-paper-2)] shadow-[var(--app-elevation-soft)]";

export const appStickyActionDockClass =
  "rounded-[var(--app-radius-card)] border border-[color:var(--color-ink)] bg-[color:var(--color-paper)] shadow-[var(--app-elevation-raised)] backdrop-blur";

export const appUtilityWidgetClass =
  "rounded-[var(--app-radius-card)] border border-[color:var(--color-ink)] bg-[color:var(--color-paper-2)] p-2 shadow-[var(--app-elevation-soft)]";

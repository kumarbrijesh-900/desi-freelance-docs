...
export const appCardClass =
  "rounded-[var(--app-radius-card)] border border-[color:var(--app-color-border)] bg-[color:var(--app-color-surface)] p-6 shadow-[var(--app-elevation-soft)] backdrop-blur-sm";

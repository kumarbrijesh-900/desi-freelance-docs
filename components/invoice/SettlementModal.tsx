  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4" role="dialog" aria-modal="true" aria-labelledby="settlement-modal-title">
      <MotionReveal preset="fade-up" className="w-full max-w-md">
        <div className="border border-soft bg-white p-6 shadow-[var(--brutal-shadow-lg)]">
          {isSuccess ? (
            <>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0"
                      disabled={isBusy}
                      className="w-full h-11 border border-soft bg-white px-4 text-sm outline-none transition-colors )] disabled:cursor-not-allowed disabled:opacity-60 app-focus-ring"
                    />

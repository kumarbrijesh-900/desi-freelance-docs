...
export function InlineStepSection({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "box shadow relative scroll-mt-32 overflow-visible rounded-[var(--radius-soft)] px-5 sm:px-8 py-7 transition-[background-color,border-color,box-shadow] duration-[var(--app-duration-medium)]",
      )}
    >

...
export function InlineStepSection({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "box shadow relative scroll-mt-32 overflow-visible rounded-[var(--radius-soft)] px-[18px] sm:px-[32px] py-[28px] transition-[background-color,border-color,box-shadow] duration-[var(--app-duration-medium)]",
      )}
    >

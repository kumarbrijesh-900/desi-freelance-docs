            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {value.logoUrl ? (
                  ...
                  <label className="group relative flex h-[46px] w-full cursor-pointer items-center justify-center gap-2 border-2 border-dashed border-soft bg-paper-2 px-4 transition hover:border-[color:var(--brand-indigo-deep)] hover:bg-[color:var(--brand-indigo-deep)]/5">
                    <input
                      type="file"
                      accept="image/*"

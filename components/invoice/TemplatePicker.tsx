    ...
    >
      ...
      >
        <div className="flex items-center gap-1">
          <div
            className="h-1.5 w-1.5 rounded-[var(--radius-soft)]"
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-[color:var(--color-paper-2)]">
        ...
        {lockState === "blurred" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/25 backdrop-blur-[1px]">
            <div className="flex h-6 w-6 items-center justify-center border border-soft rounded-[var(--radius-chip)] bg-paper-2 shadow">
        ...
        {lockState === "locked" && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/5">
            <div className="flex h-6 w-6 items-center justify-center border border-soft rounded-[var(--radius-chip)] bg-paper-2 shadow ring-1 ring-black/5">
              <LockIcon className="h-3 w-3 text-[color:var(--color-ink-2)]" />
            </div>
          </div>
        )}
        ...
        {/* Selected check */}
        {isSelected && (
          <div className="absolute right-1 top-1 flex h-4 w-4 items-center justify-center border border-soft rounded-[var(--radius-chip)] bg-[color:var(--color-lime-warm)] shadow-sm">

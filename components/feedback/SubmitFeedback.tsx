...
export default function SubmitFeedback() {
  ...
  if (isSuccess) {
    return (
      ...
      >
        ...
        <h3 className="text-lg font-black tracking-tight text-[color:var(--color-ink)] mb-2">
          Feedback Received!
        </h3>
        <p className="text-[color:var(--color-ink)] mb-6">
  ...
  return (
    <div
      className={cn(
        getAppPanelClass(),
        "p-6 max-w-lg mx-auto shadow-sm border border-[color:var(--color-soft)]",
      )}
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block text-xs font-bold uppercase tracking-widest text-[color:var(--color-ink-2)] mb-2">
            Feedback Type
          </label>
          <AppSelectField
            value={type}

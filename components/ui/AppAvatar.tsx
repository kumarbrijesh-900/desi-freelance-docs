...
export function AppAvatar({ src, initials, size = "md", className, ...props }: AppAvatarProps) {
  return (
    <div
      className={cn(
        "relative flex shrink-0 items-center justify-center overflow-hidden border border-soft bg-[color:var(--color-lime-warm)] text-[color:var(--color-ink)] font-black uppercase shadow-[var(--brutal-shadow-sm)]",
